...
public interface ComptabiliteManager {
    ...
    /**
     * Renvoie la sequence d'écritures comptables avec le code journal et l'année.
     *
     * @return {@link List}
     */
    SequenceEcritureComptable getSequenceEcritureComptableByJournalCodeAndYear(String journal_code, Integer annee);
     ...
     * @throws FunctionalException Si la Sequence de l'écriture comptable ne respecte pas les règles de gestion
     */
