...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
    ...
    public JournalComptable getJournalComptableByCode(String pCode) throws NotFoundException {
        ...
        try {
            ...
            throw new NotFoundException("JournalComptable non trouvée : code=" + pCode);
        }
        return vBean;
    }
    ...
    /** SQLgetSequenceEcritureComptableByJournalCodeAndYear */
    private static String SQLgetSequenceEcritureComptableByJournalCodeAndYear;
    public void setSQLgetSequenceEcritureComptableByJournalCodeAndYear(String pSQLgetSequenceEcritureComptableByJournalCodeAndYear) {
    	SQLgetSequenceEcritureComptableByJournalCodeAndYear = pSQLgetSequenceEcritureComptableByJournalCodeAndYear;
    }
    @Override
    public SequenceEcritureComptable getSequenceEcritureComptableByJournalCodeAndYear(String journal_code, Integer annee) throws NotFoundException {
        NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
        ...
        try {
            vBean = vJdbcTemplate.queryForObject(SQLgetSequenceEcritureComptableByJournalCodeAndYear, vSqlParams, vRM);
        } catch (EmptyResultDataAccessException vEx) {
            throw new NotFoundException("SequenceEcritureComptable non trouvée : journal_code=" + journal_code + " : annee=" + annee);
        }
        return vBean;
    }
